 ...
 */
export function userCreateUsersWithArrayInput(
  client: ReadmedeoCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.array(components.User$outboundSchema).parse(value),
  ...
  const path = pathToFunc("/user/createWithArray")();
