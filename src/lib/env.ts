...
export interface Env {
  READMEDEO_PETSTORE_AUTH?: string | undefined;

  READMEDEO_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  READMEDEO_PETSTORE_AUTH: z.string().optional(),

  READMEDEO_DEBUG: z.coerce.boolean().optional(),
});
